...
export const GET_MY_CHARACTER_SUCCESS = 'character/GET_MY_CHARACTER_REQUEST';
export const GET_MY_CHARACTER_FAILURE = 'character/GET_MY_CHARACTER_REQUEST';
export const GET_UID_CHARACTER_REQUEST = 'character/GET_UID_CHARACTER_REQUEST';
export const GET_UID_CHARACTER_SUCCESS = 'character/GET_UID_CHARACTER_REQUEST';
export const GET_UID_CHARACTER_FAILURE = 'character/GET_UID_CHARACTER_REQUEST';
